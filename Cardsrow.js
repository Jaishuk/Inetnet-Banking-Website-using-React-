...
const Cardsrow = () => {
  ...
  <Card style={{margin: "1.5em 1em"}}>
    ...
    <Card.Body>
      <Card.Title><a style={{textDecoration:'none'}} href="/Loan">Apply for loans</a></Card.Title>
      <Card.Text>
  ...
  <Card style={{ margin: "1.5em 1em"}}>
    ...
    <Card.Body>
      <Card.Title><a style={{textDecoration:'none'}} href="/Transfer">Transfer</a></Card.Title>
      <Card.Text>
  ...
  <Card style={{margin: "1.5em 1em"}}>
    ...
    <Card.Body>
      <Card.Title><a style={{textDecoration:'none'}} href="">Service</a></Card.Title>
      <Card.Text>
